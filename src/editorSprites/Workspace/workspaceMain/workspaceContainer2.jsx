...
const polygonStartRef = useRef(null);
  ...
  const [drawableWidth, setDrawableWidth] = useState(1000);
  const [drawableHeight, setDrawableHeight] = useState(1000);
    ...
    <p className='area-canvas-size-text'>{mirrorState.bounds.x2-mirrorState.bounds.x1}x{mirrorState.bounds.y2-mirrorState.bounds.y1}</p>
       ...
       ref={animationLayerRef}
        style={
          ...
          {height:"300px", width:'100%',userSelect:'none'}}>
  ...
  drawOnLayer(activeLayerId, (ctx) => {
    ...
    if (paintMode === 'composite') {
      ...
      const drawDot = (x, y, opacity = 1) => {
        ...
        //----------Validacion para no pintar fuera de los limites del viewport --------------//
        ...
        // Si el punto está fuera del área visible, no pintes
